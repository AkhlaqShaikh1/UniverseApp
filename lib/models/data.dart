...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      ...
      images: [
        'https://i.imgur.com/nZ3sUFX.jpeg',
        'https://i.imgur.com/p3bCSRA.jpeg',
        'https://i.imgur.com/BKCEl7E.jpeg'
      ]),
  PlanetInfo(2,
      name: 'Venus',
      ...
      images: [
        'https://i.imgur.com/nHpt4XC.jpeg',
        'https://i.imgur.com/Pa5g0nj.jpeg',
      ]),
  PlanetInfo(3,
      name: 'Earth',
      ...
      images: [
        'https://i.imgur.com/Q5G0fl6.jpeg',
        'https://i.imgur.com/vXghxsc.jpeg',
      ]),
  PlanetInfo(4,
      name: 'Mars',
      ...
      images: [
        'https://i.imgur.com/b3NdcZZ.jpeg',
        'https://i.imgur.com/5h6nZfp.jpeg',
      ]),
  PlanetInfo(5,
      name: 'Jupiter',
      ...
      images: [
        'https://i.imgur.com/ALbcc7r.jpeg',
        'https://i.imgur.com/Y7zhVMK.jpeg',
        'https://i.imgur.com/18169h2.jpeg',
      ]),
  PlanetInfo(6,
      name: 'Saturn',
      ...
      images: [
        'https://i.imgur.com/y2lqkWI.jpeg',
        'https://i.imgur.com/wXWadG9.jpeg',
      ]),
  PlanetInfo(7,
      name: 'Uranus',
      ...
      images: [
        'https://i.imgur.com/etjGrTO.jpeg',
        'https://i.imgur.com/YRppb67.jpeg',
      ]),
  PlanetInfo(8,
      name: 'Neptune',
      ...
      images: [
        'https://i.imgur.com/2PW28nO.jpeg',
        'https://i.imgur.com/fAMEPOJ.jpeg',
        'https://i.imgur.com/oK9aPXN.jpeg',
      ]),
];
